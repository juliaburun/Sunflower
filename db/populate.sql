...
insert into products (name, description, price, discount, image, category_id, deleted, date_sale) values 
('Helecho', 'Los helechos, son plantas vasculares sin semilla (pteridofitas), cuyas caracter�sticas morfol�gicas m�s sobresalientes son sus hojas grandes, usualmente pinadas y con prefoliaci�n circinada. La cantidad de especies y formas de los helechos les convierte en unas de las plantas m�s atractivas y espectaculares para decorar terrazas y jardines, pero tambi�n como planta de interior. En este art�culo te vamos a contar c�mo cuidarlas para que te duren mucho y se vean siempre bonitas y con vida.',
